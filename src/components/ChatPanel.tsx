...
export function ChatPanel() {
  ...
  }, [messages.length, pendingAssistant.length, streaming]);
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto p-4">
        {showPlaceholder ? (
          <div className="text-sm text-neutral-500">
            Type a one-line product idea below to draft a Project Contract. Once
            it&apos;s drafted, ask questions or request edits to refine it.
          </div>
        ) : (
